...
public:
    ...
    void DrawBorder(CellPosition cellPosition)
    {
        sf::Vector2f topLeft =
            GetBorderTopLeft() +
            sf::Vector2f(cellPosition.col, cellPosition.row) * static_cast<float>(TGameConfig::kCellSize);
    ...
    {
        return GetCellTopLeft(cellPosition) + sf::Vector2f(TGameConfig::kCellSize / 2, TGameConfig::kCellSize / 2);
    }
    ...
    {
        return sf::Vector2f(TGameConfig::kBoardLeft, TGameConfig::kBoardTop);
    }
